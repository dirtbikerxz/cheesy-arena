...
type EventSettings struct {
	...
	RedTeamSwitchManagementEnabled  bool
	RedTeamSwitchAddress            string
	RedTeamSwitchPassword           string
	RedFMSSwitchManagementEnabled   bool
	RedFMSSwitchAddress             string
	RedFMSSwitchPassword            string
	BlueTeamSwitchManagementEnabled bool
	BlueTeamSwitchAddress           string
	BlueTeamSwitchPassword          string
